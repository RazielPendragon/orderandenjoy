...
class RegistroContactoModel extends Model
{
    ...
    protected $allowedFields = ['usuario_contacto_nombre_completo','usuario_contacto_razon_social','usuario_contacto_rut','usuario_contacto_nombre_fantasia','usuario_contacto_cuidad','usuario_contacto_comuna','usuario_contacto_direccion','usuario_contacto_telefono','usuario_contacto_correo'];
